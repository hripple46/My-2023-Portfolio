  ...
  return (
    <div className="pb-24 flex  w-full items-center justify-center items-center text-white">
      <div className="w-2/3 flex flex-wrap items-start justify-center">
        <div className="border-2 m-2  border-orange-300/25 rounded-md p-4 flex flex-col justify-center items-center w-full md:w-1/3">
          ...
          <p className="text-white">
            ...
            Client-Side, Backend (RESTful API), and Databse (MongoDB) for
        ...
        <div className="border-2 border-orange-300/25 rounded-md p-4 pt-16 md:pt-4 flex flex-col justify-center items-center w-full md:w-1/3 m-2">
          <div className="w-full flex justify-between items-center">
          ...
          <p>
            ...
            development. The integration of features such as a title-based
            search function and a star rating system demonstrated a solid grasp
            of creating intuitive and efficient user interfaces.
          </p>
        </div>
        <div className="border-2 border-orange-300/25 rounded-md p-4 pt-8 flex flex-col justify-center items-center w-full md:w-1/3 m-2">
          <div className="w-full flex justify-between items-center">
          ...
          ></img>
          <p>
            In this project, the development of a dynamic web application
            allowed for an impressive showcase of an author's work while
            promoting user engagement. The use of Google Firestore underscored
            my capabilities in robust data management, and the design emphasis
            on the author's styling and community interaction highlighted a
