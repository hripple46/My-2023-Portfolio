      ...
      <div className="w-full h-full bg-neutral-950">
          ...
          <div className="flex justify-evenly w-full items-center">
            ...
            <div className="flex">
              ...
              <h1
                ...
                className="border-2 border-white md:p-2 p-1  hover:bg-gray-400 md:mt-4  md:pb-2 rounded-lg text-md  hover:cursor-pointer"
              >
                Projects
              </h1>
            </div>
            {
              //<h1 className="text-lg">Toggle Night</h1//
            }
          </div>
        </div>
        ...
        <div ref={skillsRef} className="w-full ">
          <div className="text-white w-full flex flex-col">
            ...
            <div className="w-full flex flex-col items-center">
              <div className="flex w-2/3 justify-start border-b-2 pb-2">
                <h1 className="pb-2 pt-8 text-white text-center text-xl">
                  Skills
                </h1>
              </div>
        ...
        >
          <path d="M480-351l173-173-43-42-130 130-130-130-43 42 173 173zm0 271q-82 0-155-31.5t-127.5-86Q143-252 111.5-325T80-480q0-83 31.5-156t86-127Q252-817 325-848.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 82-31.5 155T763-197.5q-54 54.5-127 86T480-80zm0-60q142 0 241-99.5T820-480q0-142-99-241t-241-99q-141 0-240.5 99T140-480q0 141 99.5 240.5T480-140zm0-340z"></path>
        </svg>
      </div>
    </>
  );
